...
(function (global) {
  ...
  function userToProfile(user) {
    ...
    return {
      ...
      gender: user.gender || "",
      age: user.age != null && Number.isInteger(user.age) ? user.age : null,
  ...
  function syncSessionUserFromProfile(profile) {
    ...
    setSession(session.token, {
      ...
      age: profile.age != null ? profile.age : session.user?.age ?? null,
      bodyType: profile.bodyType ?? session.user?.bodyType ?? "",
      interestedIn: profile.interestedIn ?? session.user?.interestedIn ?? "",
